...
export const fetchShorts = async (shortsId) => {
  const options = {
    method: 'GET',
    url: `https://yt-api.p.rapidapi.com/shorts/info?id=${shortsId}`,
    params: {
      geo: 'BR',
      lang: 'pt'
    },
  ...
  try {
    ...
    console.error('Erro ao realizar a pesquisa de shorts:', error);
    throw error;
  }
};

export const fetchNextShorts = async (shortsId) => {
  const options = {
    method: 'GET',
    url: `https://yt-api.p.rapidapi.com/shorts/sequence?id=${shortsId}`,
    params: {
      geo: 'BR',
      lang: 'pt'
    },
